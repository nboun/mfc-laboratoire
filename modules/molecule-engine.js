...
const MOLECULE_DB = {
    ...
    '431-03-8':  { name: 'Diacétyle', family: 'dicétone', mw: 86.09, fp: 2, volatility: 'très_haute',
                   impact_combustion: 'danger', impact_diffusion: 'flash', solubility_wax: 'partielle',
    ...
    '84-66-2':   { name: 'Diéthyl phtalate (DEP)', family: 'plastifiant', mw: 222.24, fp: 117, volatility: 'basse',
                  impact_combustion: 'neutre', impact_diffusion: 'neutre', solubility_wax: 'partielle',
    ...
    '25265-71-8':{ name: 'Dipropylène glycol (DPG)', family: 'glycol-solvant', mw: 134.17, fp: 118, volatility: 'basse',
                  impact_combustion: 'neutre', impact_diffusion: 'neutre', solubility_wax: 'insoluble',
...
const { ODOR_DB } = require('./molecule-odors');
